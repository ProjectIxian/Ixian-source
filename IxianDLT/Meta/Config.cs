...
namespace DLT
{
    namespace Meta
    {
        ...
        public class Config
        {
            ...
            public static readonly byte[] foundationAddress = Base58Check.Base58CheckEncoding.DecodePlain("1ixianinfinimine234234234234234234234234234242HP"); // Foundation wallet address
